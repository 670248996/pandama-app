  ...
  <view class="container">
    <view class="example">
      <uni-forms ref="form" :model="device" labelWidth="80px">
        ...
        <uni-forms-item label="出库数量" name="operationNum">
          <uni-easyinput type="number" v-model="device.operationNum" placeholder="请输入出库数量"  />
        </uni-forms-item>
        <uni-forms-item label="购买方" name="customerName">
          <uni-easyinput v-model="device.customerName" placeholder="请输入购买方" />
        </uni-forms-item>
      </uni-forms>
...
<script>
  import { subStore, deviceDetail } from "@/api/system/device"
