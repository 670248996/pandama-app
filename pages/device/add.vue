  ...
  <view class="container">
    <view class="example">
      <uni-forms ref="form" :model="device" labelWidth="80px">
        ...
        <uni-forms-item label="库存" name="store" required>
          <uni-easyinput type="number" v-model="device.store" placeholder="请输入库存" />
        </uni-forms-item>
...
<script>
import { addDevice, deviceDetail } from "@/api/system/device"
